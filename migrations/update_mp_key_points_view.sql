...
FROM 
  ...
  LEFT JOIN public.members m ON m.member_id = (kp->'speaker'->>'memberId')::integer
WHERE 
...
-- Set owner
ALTER MATERIALIZED VIEW public.mp_key_points OWNER TO authenticator;
...
-- Set index owners
ALTER INDEX idx_mp_key_points_unique OWNER TO authenticator;
ALTER INDEX idx_mp_key_points_member_id OWNER TO authenticator;
ALTER INDEX idx_mp_key_points_date OWNER TO authenticator;
...
-- Set function owner
ALTER FUNCTION public.refresh_mp_key_points() OWNER TO authenticator;
