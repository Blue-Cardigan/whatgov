import type { Contribution } from "@/types/search";
...
import { CalendarIcon, ExternalLink, Settings2, UserIcon } from "lucide-react";
  ...
  return (
    <Card 
      ...
      style={{ 
        ...
        backgroundImage: `linear-gradient(to right, ${locationColors[result.House]}08, transparent 15%)`,
      }}
    >
      {/* Top Actions Bar */}
